        ...
        {currentProducts.map((p) => (
          <div
            ...
            style={{
              ...
              padding: "12px",
              borderRadius: "8px",
              display: "flex",           // 🔹 Tambahan: membuat card flex vertical
              flexDirection: "column",   // 🔹 Tambahan: isi card atas ke bawah
              justifyContent: "space-between", // 🔹 Tambahan: memisahkan konten dan link
              height: "100%",            // 🔹 Tambahan: agar tombol tetap di bawah
            }}
          >
            <div>
              ...
              <Link style={{textAlign: "right" }} href={`/products/${slugify(p.title)}`}>Lihat Detail →</Link>
